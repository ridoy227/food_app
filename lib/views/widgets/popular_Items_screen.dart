...
import 'package:food_app/views/pages/item_details_page.dart';
      ...
      child: ListView.builder(
        ...
        itemBuilder: ((context, index) {
          return InkWell(
             onTap: (){
              final myist = [
              _searchPageController.popularitems[index].title,
              _searchPageController.popularitems[index].description,
              _searchPageController.popularitems[index].imglink,
              _searchPageController.popularitems[index].price,
              _searchPageController.popularitems[index].ranking
              
               ];


                    Get.to( ItemDetails(), arguments: myist);
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Hero(
                        tag: _searchPageController.popularitems[index].imglink,
